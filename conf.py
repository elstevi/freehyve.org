...
BLOG_AUTHOR = "Steven Douglas"  # (translatable)
BLOG_TITLE = "freehyve"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://freehyve.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://freehyve.org/"
BLOG_EMAIL = "owner@freehyve.org"
BLOG_DESCRIPTION = "the freebsd hypervisor glue"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("https://github.com/elstevi/freehyve-build/releases", "Downloads"),
    ),
}
